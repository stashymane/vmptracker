...
@Composable
fun FaceSettingsDialog(state: SettingsViewmodel.FaceTrackingState, modifier: Modifier) {
    var runnerDialogVisible by state.runnerDialogVisible
    var runner by state.runner
...
@Preview
@Composable
private fun FaceSettingsPartPreview() {
    VTrackerTheme {
        FaceSettingsPart(SettingsViewmodel.FaceTrackingState())
    }
}